...
var rootCmd = &cobra.Command{
	Use:   "inferall",
	Short: "AI coding agent powered by InferAll",
	Long: `InferAll is a powerful terminal-based AI coding agent that helps with software development tasks.
It provides an interactive chat interface with AI capabilities, code analysis, and LSP integration
to assist developers in writing, debugging, and understanding code directly from the terminal.

Powered by InferAll's multi-provider AI gateway (https://inferall.ai).`,
	Example: `
  ...
  inferall -p "Explain the use of context in Go"
  `,
